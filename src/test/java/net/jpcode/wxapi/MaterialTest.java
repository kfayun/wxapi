...
import net.jpcode.wxapi.request.MaterialAddRequest;
import net.jpcode.wxapi.request.MaterialDeleteRequest;
import net.jpcode.wxapi.request.MaterialGetcountRequest;
